    ...
    <form className="client-form-card" onSubmit={handleSubmit}>
      ...
      <section className="client-form-section">
        ...
        <div className="client-form-fields">
          <label className="full"><span className="field-label">案件名 <i className="required-symbol">※</i></span><input name="name" data-max-length={150} required autoFocus/></label>
          ...
          <label className="full"><span className="field-label">説明</span><textarea name="description" data-max-length={1000} rows={3}/></label>
        </div>
      </section>
      <section className="client-form-section">
