export type Project = { id: string; name: string; client: string; color: string; soft: string }
...
export type Client = {id: string; name: string; contact: string; email: string; status: ClientStatus; projects: number; revenue: number; receivable: number; lastActivity: string; initials: string; color: string; soft: string}
...
export type ProjectDetail = {status: ProjectStatus; statusLabel: string; progress: number; budget: string; deadline: string; usedHours: number; targetHours: number}
